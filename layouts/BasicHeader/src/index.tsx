...
export const BasicHeader: React.FC<BasicHeaderProps> = ({
  className, style, headerLeft, headerAction, onCollapsed, collapsed = false
}) => {
  ...
  const HeaderLeft = headerLeft ? headerLeft : <BasicHeaderLeft showBreadcrumb collapsed={collapsed} onCollapsed={onCollapsed} />
  return (
    <Header
      className={clsName}
      style={style}
